...
working on allowing characters of variance:
based on this script which allows a single character of variance among the last name, but only if the names are the same length with the  target name =  Parker
SQL:
